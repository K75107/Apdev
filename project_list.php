		...
		<div class="card-body">
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$stat = array("Pending","Started","On-Progress","On-Hold","Cancelled","Done");
					$where = "";
					...
					<tr>
						...
						<td class="text-center">
							...
							<a class="dropdown-item view_project" href="javascript:void(0);" data-id="<?php echo $row['id'] ?>" onclick="assignProjectId(<?php echo $row['id'] ?>)">View</a>
...
<script>
    ...
    // Assign the project ID to the new variable
    var project_id = projectId;
    // Now you can use the project_id variable as needed
    console.log("Project ID: " + project_id);
    // For example, you can redirect to another page with the project ID in the URL
