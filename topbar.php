<!-- Navbar -->
  <nav class="main-header navbar navbar-expand " style = "background-color: #007260">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
            ...
            <a class="nav-link"  data-toggle="dropdown" aria-expanded="true" href="javascript:void(0)">
              <span>
                <div class="d-felx badge-pill">
                  <span class="fa fa-user mr-2" style = "color: #FFF"></span>
                  <span><b style = "color: #FFF"><?php echo ucwords($_SESSION['login_firstname']) ?></b></span>
                  <span class="fa fa-angle-down ml-2" style = "color: #FFF"></span>
                </div>
              </span>
            </a>
